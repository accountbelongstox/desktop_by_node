                                ...
                                <ul class="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    ...
                                    <li class="border-t border-white-light dark:border-white-light/10">
                                        <router-link to="/auth/boxed-signin" class="text-danger !py-3" @click="close()">
                                            <svg
                                                class="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 rotate-90"
                                                width="18"
                                                height="18"
                                                viewBox="0 0 24 24"
                                                fill="none"
            ...
            >
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="relative">
                            ...
                            >
                                ...
                                <li>
                                    <router-link to="/datatables/alt-pagination">{{ $t('alt._pagination') }}</router-link>
                                </li>
                                <li>
                ...
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <router-link to="/forms/checkbox-radio">{{ $t('checkbox_&_radio') }}</router-link>
                        </li>
                        <li>
                        ...
                        <li>
                            <router-link to="/forms/date-picker">{{ $t('date_&_range_picker') }}</router-link>
                        </li>
                        <li>
                ...
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="javascript:;">{{ $t('documentation') }}</a>
                        </li>
                    </ul>
                </li>
            </ul>
