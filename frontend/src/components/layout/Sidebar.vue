                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'datatables'">
                                <ul class="sub-menu text-gray-500">
                                    ...
                                    <li>
                                        <router-link to="/datatables/alt-pagination" @click="toggleMobileMenu">{{ $t('alt._pagination') }}</router-link>
                                    </li>
                                    <li>
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'forms'">
                                <ul class="sub-menu text-gray-500">
                                    ...
                                    <li>
                                        <router-link to="/forms/checkbox-radio" @click="toggleMobileMenu">{{ $t('checkbox_&_radio') }}</router-link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <router-link to="/forms/date-picker" @click="toggleMobileMenu">{{ $t('date_&_range_picker') }}</router-link>
                                    </li>
                                    <li>
