        ...
        <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6 mt-8 ">
          ...
          hover:scale-[1.01]">
                        <Tab as="template" v-slot="{ selected }">
                            <a href="javascript:;"
                                class="w-12 h-12 flex items-center justify-center rounded-l-full rounded-r-full bg-[#f1f2f3] dark:bg-[#191e3a] hover:!bg-info hover:text-white hover:shadow-[0_5px_15px_0_rgba(0,0,0,0.30)] transition-all duration-300 !outline-none"
