    ...
    <div>
        ...
        <div class="pt-5">
            <div class="flex gap-4">
                <div class="panel bg-gradient-to-r from-cyan-500 to-cyan-400 w-2/3 bg-blue-200 p-4">
                    <v-carousel>
                        <v-carousel-item v-for="(item, index) in items" :key="index" v-show="currentIndex === index">
                            <div>{{ item.text }}</div>
                        </v-carousel-item>
                    </v-carousel>
                </div>
...
<script lang="ts" setup>
    ...
    const totalItems = ref<number>(items.value.length);
