    ...
    <div>
        <div class="grid xl:grid-cols-3 gap-6 mb-6">
            <div class="panel h-full xl:col-span-2">
                ...
                <div class="relative">
                    <apexchart height="325" :options="revenueChart" :series="revenueSeries" class="bg-white dark:bg-black rounded-lg">
                        <!-- loader -->
            ...
            <div class="panel h-full">
                ...
                <div>
                    <apexchart height="460" :options="salesByCategory" :series="salesByCategorySeries" class="bg-white dark:bg-black rounded-lg">
                        <!-- loader -->
        ...
        <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-6">
            <div class="panel h-full sm:col-span-2 xl:col-span-1">
                ...
                <div>
                    <apexchart height="160" :options="dailySales" :series="dailySalesSeries" class="bg-white dark:bg-black rounded-lg">
                        <!-- loader -->
            ...
            <div class="panel h-full p-0">
                ...
                <apexchart height="290" :options="totalOrders" :series="totalOrdersSeries" class="bg-white dark:bg-black rounded-lg">
                    <!-- loader -->
            ...
            <div class="panel h-full">
                ...
                <div>
                    <div class="space-y-6">
                        <div class="flex">
                            <span
                                class="grid place-content-center text-base w-9 h-9 rounded-md bg-success-light dark:bg-success text-success dark:text-success-light"
                                >SP</span
                            >
                        ...
                        <div class="flex">
                            <span class="grid place-content-center text-base w-9 h-9 rounded-md bg-info-light dark:bg-info text-info dark:text-info-light"
                                >DA</span
                            >
                            <div class="px-3 flex-1">
            ...
            <div class="panel h-full sm:col-span-2 lg:col-span-1">
                ...
                <div class="grid sm:grid-cols-2 gap-8 text-sm text-[#515365] font-bold">
                    <div>
                        ...
                        <apexchart height="58" :options="totalVisit" :series="totalVisitSeries">
                            <!-- loader -->
                    ...
                    <div>
                        ...
                        <apexchart height="58" :options="paidVisit" :series="paidVisitSeries">
                            <!-- loader -->
                            <div class="min-h-[58px] grid place-content-center bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08]">
                                <span
                                    class="animate-spin border-2 border-black dark:border-white !border-l-transparent rounded-full w-5 h-5 inline-flex"
        ...
        <div class="grid lg:grid-cols-3 gap-6 mb-6">
            <div class="panel h-full p-0 lg:col-span-2">
                ...
                <apexchart height="360" :options="uniqueVisitor" :series="uniqueVisitorSeries">
                    <!-- loader -->
            ...
            <div class="panel h-full">
                ...
                <perfect-scrollbar
                    ...
                    class="relative h-[360px] pr-3 -mr-3"
                >
                    <div class="space-y-7">
                        <div class="flex">
                            <div
                            ...
                            <div>
                                <h5 class="font-semibold dark:text-white-light">
                                    New project created : <a href="javascript:;" class="text-success">[DevOps Admin Template]</a>
                                </h5>
        ...
        <div class="grid sm:grid-cols-3 xl:grid-cols-5 gap-6 mb-6">
            ...
            <div class="panel h-full p-0">
                ...
                <div class="h-40">
                    <apexchart height="160" :options="followers" :series="followersSeries" class="w-full absolute bottom-0">
                        <!-- loader -->
