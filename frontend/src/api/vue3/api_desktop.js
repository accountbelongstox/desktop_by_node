...
const controllerDesktopType = `controller.desktop`
const controllerDesktop = `${controllerDesktopType}.desktop`
const ipcApiRoute = {
    getDesktopList: `${controllerDesktop}.getSfotlist`,
    getBackgroundByNetwork: `${controllerDesktop}.getBackgroundByNetwork`,
    installSoftware: `${controllerDesktop}.installSoftware`,
    runSoftware: `${controllerDesktop}.runSoftware`,
    getbasicEnvList: `${controllerDesktop}.getbasicEnvList`,
    a: `${controllerDesktop}.`,
    a: `${controllerDesktop}.`,
    a: `${controllerDesktop}.`,
    a: `${controllerDesktop}.`,
