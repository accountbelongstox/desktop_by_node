...
const { tool, conf, json, file } = require('../node_provider/utils.js');
const { http, serve } = require('../node_provider/practicals.js');
const { env } = require('../node_provider/globalvars.js');
const { elec, ctrl, view } = require('../node_provider/electron.js');
